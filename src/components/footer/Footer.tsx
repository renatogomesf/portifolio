  ...
  return (
    <>
      <footer className="bg-[#000105] pt-20 pb-10 px-2.5">
        <section
          id="sec05"
          className="section text-white max-w-[1150px] m-auto scroll-mt-[100px]"
        >
          ...
          <div className="mt-20 flex justify-between max-md:flex-col max-md:gap-10">
            <div>
              ...
              <p className="text-[#fff] text-[1.5rem] font-normal mt-5">
                Não sou difícil de econtrar, me envie uma mensagem!
              </p>
              <div className="mt-5">
          ...
          <div className="mt-15 text-center">© Renato Gomes</div>
        </section>
      </footer>
    </>
  );
